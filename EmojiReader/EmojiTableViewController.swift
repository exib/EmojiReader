...
class EmojiTableViewController: UITableViewController {
    ...
    let objects = [
        ...
        Emoji(emoji: "🏅", name: "Champion", description: "Thank you my little friends", isFavourite: false),
        Emoji(emoji: "😎", name: "Cool boy!", description: "Yeah, Baby! I'am so cool!", isFavourite: false)
    ]
